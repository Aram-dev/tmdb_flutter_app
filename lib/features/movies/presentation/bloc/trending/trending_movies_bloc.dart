...
class TrendingMoviesBloc
  ...
  Future<void> _load(
    ...
    try {
      ...
      final trendingMovies = await trendingMoviesUseCase
          .getTrendingMovies('bc0abeeb117c70b4a31a9b439dd7e981', 'us-US', 'day');
      emit(TrendingMoviesLoaded(trendingMovies: trendingMovies, currentWindow: 'day', isExpanded: true));
    } catch (e, st) {
